...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "hero-desktop": ["72px", { lineHeight: "1.1", letterSpacing: "-0.03em" }],
        "hero-tablet": ["48px", { lineHeight: "1.1", letterSpacing: "-0.02em" }],
        "hero-mobile": ["36px", { lineHeight: "1.15", letterSpacing: "-0.01em" }],
